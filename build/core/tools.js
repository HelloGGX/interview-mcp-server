...
export function registerTools(server) {
    server.addTool({
        ...
        description: "Generate interview questions based on a PDF resume file. Use this tool when mentions /q",
        parameters: z.object({
            absolutePathToPdfFile: z
                .string()
                .describe("Absolute path to the PDF resume file that will be analyzed to generate relevant interview questions"),
            position: z
                .enum(["frontend", "backend", "test", "ui", "ux"])
                .describe("The target position type for the interview: frontend developer, backend developer, or test engineer"),
            level: z
                .enum(["junior", "mid", "senior"])
                .describe("The target experience level for the interview questions: junior (entry-level), mid (intermediate), or senior (advanced/leadership)"),
        }),
    ...
    server.addTool({
        ...
        description: "Evaluate the interviewer's performance based on the interview conversation, Use this tool when mentions /e",
        parameters: z.object({
